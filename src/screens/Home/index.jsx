      ...
      <Container sx={{ color: THEME_COLORS.TEXT_100 }}>
        ...
        <Stack>
          ...
          >
            ...
            data in real-time, without sacrificing performance. We obsess over
            the gnarly details of cleaning, normalizing and transforming data so
            you can create engaging UI that users love.
          </Typography>
          <Typography
            mx={"auto"}
            // fontSize={"25px"}
          ...
          >
            ...
            build you a custom endpoint with the complexity your app needs to
